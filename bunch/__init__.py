...
class Bunch(dict):
    """ A dictionary that provides attribute-style access.
        ...
        See unbunchify/Bunch.to_dict, bunchify/Bunch.from_dict for notes about conversion.
    """
    ...
    def from_dict(d):
        """ Recursively transforms a dictionary into a Bunch via copy.
            ...
            >>> b = Bunch.from_dict({'urmom': {'sez': {'what': 'what'}}})
            >>> b.urmom.sez.what
            'what'
...
try:
    ...
    def to_yaml(self, **options):
        """ Serializes this Bunch to YAML, using `yaml.safe_dump()` if
            ...
            >>> yaml.safe_dump(b, default_flow_style=True)
            '{foo: [bar, {lol: true}], hello: 42}\\n'
            >>> b.to_yaml(default_flow_style=True)
            '{foo: [bar, {lol: true}], hello: 42}\\n'
            >>> yaml.dump(b, default_flow_style=True)
            '!bunch.Bunch {foo: [bar, !bunch.Bunch {lol: true}], hello: 42}\\n'
    ...
    Bunch.to_yaml = to_yaml
    Bunch.from_yaml = staticmethod(from_yaml)
